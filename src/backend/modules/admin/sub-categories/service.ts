...
export const getAllSubCategories = async () => {
  return await SubCategory.find().populate("category", "name code").sort({ createdAt: -1 });
};
...
export const getSubCategoryByNameAndCategory = async (name: string, categoryId: string) => {
...
export const updateSubCategory = async (id: string, data: UpdateSubCategoryDto) => {
