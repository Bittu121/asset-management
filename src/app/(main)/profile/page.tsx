...
//                         </div>
//                         <span
//                           className={`px-2 py-1 text-xs rounded ${getStatusStyle(asset.status)}`}
//                         >
//                           {asset.status}
//                         </span>
//                       </div>
...
export default function Page() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {currentUser.role === "technician" && <TechnicianProfile user={currentUser} />}
