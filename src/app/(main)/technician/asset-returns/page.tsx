  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">History of all returned assets</p>
      </div>
      <div className="bg-white rounded-2xl border border-gray-100 p-5">
        <div className="flex gap-3 mb-5">
          ...
          />
          <span className="text-sm text-gray-400 self-center">{filtered.length} records</span>
        </div>
        {loading ? (
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {filtered.map((r) => (
                  ...
                  >
                    <td className="py-3 pr-4 font-semibold text-indigo-600">{r.assetTag}</td>
                    <td className="py-3 pr-4 text-gray-700">{r.device || "—"}</td>
                    <td className="py-3 pr-4 text-gray-700">{r.returnedBy}</td>
                    <td className="py-3 pr-4 text-gray-500 text-xs">{r.returnedByEmail}</td>
                    ...
                    <td className="py-3 pr-4 text-gray-600 text-xs">{r.returnCondition || "—"}</td>
